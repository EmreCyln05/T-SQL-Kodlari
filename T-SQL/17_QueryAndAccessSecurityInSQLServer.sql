...
EXEC KullaniciDogrula 'emreceylan', 'emre.sifre';
...
EXEC sp_helplogins 'xbank_developer';
...
ALTER LOGIN gelistirici WITH NAME = xbank_developer;

ALTER LOGIN xbank_developer WITH PASSWORD = 'yeni_sifre-1().,+%11';

ALTER LOGIN xbank_developer MUST_CHANGE;

ALTER LOGIN xbank_developer CHECK_POLICY = ON;

ALTER LOGIN xbank_developer CHECK_EXPIRATION = ON;


--	Sunucu Eriþimi Vermek ya da Kaldýrmak


GRANT CONNECT SQL TO xbank_developer;

DENY CONNECT SQL TO xbank_developer;


--	Oturumlarý Etkinleþtirmek, Devre Dýþý Býrakmak ve Kilidini Kaldýrmak


ALTER LOGIN xbank_developer DISABLE;


ALTER LOGIN xbank_developer ENABLE;


ALTER LOGIN xbank_developer WITH PASSWORD = '123456' UNLOCK;


--	Þifreleri Deðiþtirmek


ALTER LOGIN xbank_developer WITH PASSWORD = 'yeni_sifre11-2&5%';
...
EXEC sp_addsrvrolemember xbank_developer, sysadmin;


EXEC sp_dropsrvrolemember xbank_developer, sysadmin;
